...
public class FastingBloodSugarCalculation extends AbstractPatientCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> collection, Map<String, Object> map,
		...
		CalculationResultMap fbs = Calculations.lastObs(Dictionary.getConcept("160912AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
