...
public class RandomBloodSugarCalculation extends AbstractPatientCalculation {
	...
	public CalculationResultMap evaluate(Collection<Integer> collection, Map<String, Object> map,
		...
		CalculationResultMap rbs = Calculations.lastObs(Dictionary.getConcept("887AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"),
