...
public class Procedure {
	...
	static {
		...
		Collection<ConceptAnswer> minorOperationConcepts = Context.getConceptService().getConceptByName("MINOR OPERATION")
		        .getAnswers();
		Collection<ConceptAnswer> majorOperationConcepts = Context.getConceptService().getConceptByName("MAJOR OPERATION")
		        .getAnswers();
	...
	public void save(Encounter encounter) throws Exception {
		Concept procedureConcept = Context.getConceptService().getConceptByName(
		    Context.getAdministrationService()
		            .getGlobalProperty(PatientDashboardConstants.PROPERTY_POST_FOR_PROCEDURE, null));
